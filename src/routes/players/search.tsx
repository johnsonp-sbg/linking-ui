    ...
    return (<>
        ...
        <div id='results'>
            <table>
                ...
                <tbody>
                    {players.map((player: any, key: number) => (<tr className='navigation' key={key} onClick={() => navigate(`/players/${player.playerId}`)}>
                        ...
                        <td>{player.teams.map((team: any) => team.name).join('; ')}</td>
                    </tr>))}
                </tbody>
            </table>
        </div>
