...
This is a basic start to the linking UI that can be used by traders to update canonical linking without calling out individuals in TSI. It is a simple ReactJS application that has been created with create-react-app (see docs at the bottom).
